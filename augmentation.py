...
# dataset
# random masking (span=1)
# random_masking_replacement_train = orig_train.copy()
# random_masking_replacement_train['sentence1'] = random_masking_replacement_train['sentence1'].progress_apply(lambda x: random_masking_replacement(x, span=1) if len(x.split()) > 1 else x)
# random_masking_replacement_train['sentence2'] = random_masking_replacement_train['sentence2'].progress_apply(lambda x: random_masking_replacement(x, span=1) if len(x.split()) > 1 else x)
...
# random_masking_replacement_augset.reset_index().to_json('sts/datasets/klue-sts-v1.1_train_random_masking_replacement_augset_span1.json')

# random masking (span=2)
# random_masking_replacement_train = orig_train.copy()
# random_masking_replacement_train['sentence1'] = random_masking_replacement_train['sentence1'].progress_apply(lambda x: random_masking_replacement(x, span=2) if len(x.split()) > 2 else random_masking_replacement(x, span=1) if len(x.split()) > 1 else x)
# random_masking_replacement_train['sentence2'] = random_masking_replacement_train['sentence2'].progress_apply(lambda x: random_masking_replacement(x, span=2) if len(x.split()) > 2 else random_masking_replacement(x, span=1) if len(x.split()) > 1 else x)
# random_masking_replacement_augset = pd.concat([orig_train, random_masking_replacement_train])
# random_masking_replacement_augset.drop_duplicates(['sentence1', 'sentence2'], inplace=True)
# print(len(random_masking_replacement_augset))

# random_masking_replacement_augset.reset_index().to_json('sts/datasets/klue-sts-v1.1_train_random_masking_replacement_augset_span2.json')

# # random insertion (num=1)
# random_masking_insertion_train = orig_train.copy()
# random_masking_insertion_train['sentence1'] = random_masking_insertion_train['sentence1'].progress_apply(lambda x: random_masking_insertion(x, num=1))
# random_masking_insertion_train['sentence2'] = random_masking_insertion_train['sentence2'].progress_apply(lambda x: random_masking_insertion(x, num=1))
...
# random_masking_insertion_augset.reset_index().to_json('sts/datasets/klue-sts-v1.1_train_random_masking_insertion_augset_num1.json')

# # random insertion (num=2)
# random_masking_insertion_train = orig_train.copy()
# random_masking_insertion_train['sentence1'] = random_masking_insertion_train['sentence1'].progress_apply(lambda x: random_masking_insertion(x, num=2))
# random_masking_insertion_train['sentence2'] = random_masking_insertion_train['sentence2'].progress_apply(lambda x: random_masking_insertion(x, num=2))
# random_masking_insertion_augset = pd.concat([orig_train, random_masking_insertion_train])
# random_masking_insertion_augset.drop_duplicates(['sentence1', 'sentence2'], inplace=True)
# print(len(random_masking_insertion_augset))
# random_masking_insertion_augset.reset_index().to_json('sts/datasets/klue-sts-v1.1_train_random_masking_insertion_augset_num2.json')
